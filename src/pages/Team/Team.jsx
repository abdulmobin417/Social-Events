  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <p className="max-w-[900px] text-center mt-4 text-[#706F6F]">
        Our team comprises experienced professionals, including event planners,
        decorators, caterers, and entertainers, all dedicated to making your
        event a success. Each member brings expertise and creativity to ensure
        every aspect of your celebration is executed flawlessly.
      </p>
      <div className="mt-8">
        <div className="flex flex-wrap gap-4 justify-center">
          <div className="text-[#767676] max-w-[300px] border p-4">
            <img className="w-full" src={organizer2} alt="" />
            <h2 className="text-lg font-medium mt-3">Kenneth Kneeland</h2>
            <p className=" text-sm font-medium">Manager, CEO</p>
            <p className="max-w-[270px] mb-5">
              Best Weeding organizer in the world in this moment
            </p>
          ...
          <div className="text-[#767676] max-w-[300px] border p-4">
            <img className="w-full" src={organizer1} alt="" />
            <h2 className="text-lg font-medium mt-3">Kenneth Kneeland</h2>
            <p className=" text-sm font-medium">Manager, CEO</p>
            <p className="max-w-[270px] mb-5">
              Best Weeding organizer in the world in this moment
          ...
          <div className="text-[#767676] max-w-[300px] border p-4">
            <img className="w-full" src={organizer4} alt="" />
            <h2 className="text-lg font-medium mt-3">Kenneth Kneeland</h2>
            <p className=" text-sm font-medium">Manager, CEO</p>
            <p className="max-w-[270px] mb-5">
              Best Weeding organizer in the world in this moment
          ...
          <div className="text-[#767676] max-w-[300px] border p-4">
            <img className="w-full" src={organizer3} alt="" />
            <h2 className="text-lg font-medium mt-3">Kenneth Kneeland</h2>
            <p className=" text-sm font-medium">Manager, CEO</p>
            <p className="max-w-[270px] mb-5">
              Best Weeding organizer in the world in this moment
